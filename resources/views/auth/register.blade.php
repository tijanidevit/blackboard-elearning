...
<body>
                        ...
                        <div class="w-100">
                            ...
                            <form method="POST" action="{{ route('register.post') }}">
                                ...
                                <div class="input-block">
                                    ...
                                    <x-form.error-message record='name' />
                                </div>
                                <div class="input-block">
                                    <label class="form-control-label">Email</label>
                                    <input type="email" id="email" required value="{{ old('email') }}"
                                ...
                                <div class="input-block">
                                    ...
                                    <x-form.error-message record='role' />
                                </div>
    ...
    <script src="/assets/js/rocket-loader.min.js" data-cf-settings="c8b33ed5478c9d6d8fbfda55-|49" defer></script>
</body>
